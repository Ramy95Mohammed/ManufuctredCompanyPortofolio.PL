...
namespace ManufuctredCompanyPortofolio.DAL.Migrations
{
    ...
    [Migration("20240214132154_manufuctredCompaniesBranchesResPeople")]
    partial class manufuctredCompaniesBranchesResPeople
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManufuctredCompanyPortofolio.DAL.Entities.CompanyBranchesResponsiblePerson", b =>
                {
                    ...
                    b.Property<int>("ManuductringCompanyBranchId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PersonArName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PersonEnName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("KeyID");

                    b.HasIndex("ManuductringCompanyBranchId");

                    b.HasIndex("ManufcturingCompanyId");

                    b.ToTable("CompanyBranchesResponsiblePeople");
                });
            ...
            modelBuilder.Entity("ManufuctredCompanyPortofolio.DAL.Entities.CompanyBranchesResponsiblePerson", b =>
                {
                    b.HasOne("ManufuctredCompanyPortofolio.DAL.Entities.ManuductringCompanyBranch", "ManuductringCompanyBranch")
                        .WithMany("CompanyBranchesResponsiblePeople")
                        .HasForeignKey("ManuductringCompanyBranchId")
                    ...
                    b.Navigation("ManuductringCompanyBranch");
            ...
            modelBuilder.Entity("ManufuctredCompanyPortofolio.DAL.Entities.ManuductringCompanyBranch", b =>
                {
                    b.Navigation("CompanyBranchesResponsiblePeople");
                });
